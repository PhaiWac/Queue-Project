                ...
                <div action="" class="sm:w-2/3 w-full px-4 lg:px-0 mx-auto">
                    ...
                    <div class="max-w-lg mx-auto">
                        <button
                            ...
                            type="button" data-dropdown-toggle="dropdown">ลงทะเบียน<svg class="w-4 h-4 ml-2" fill="none"
    ...
    $('#submit').click(function() {
        ...
        $.ajax({
            ...
            success : function(res) {
                ...
                if (res) {
                    // Go Home ;
                    window.location.href = '../controller/Home.php?id=MainHome';
                }
            }
        })
    })
